...
@section('contenido')
    ...
    <div
        class="px-6 lg:px-16 py-10 bg-white text-gray-800 flex flex-col lg:flex-row lg:items-start lg:space-x-8   animate__animated animate__zoomIn">
        <!-- Texto de la sección -->
        <div class="lg:w-2/3">
            ...
            <p class="text-lg mt-4 text-justify           animate__animated animate__zoomIn">
                Nuestro programa de responsabilidad social también incluye actividades de capacitación y educación para los
                miembros de estas comunidades, brindándoles habilidades que puedan ser aplicadas en su día a día y, a su
                vez, ayudándoles a integrarse mejor en el ámbito laboral. De esta manera, nos aseguramos de contribuir al
                desarrollo integral de las personas, generando valor compartido y construyendo un futuro más próspero para
                todos.
            </p>
        </div>
