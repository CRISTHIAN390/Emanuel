        ...
        <div class="container mx-auto px-6 lg:px-8 space-y-10 lg:max-w-5xl">
            <div class="col-12 animate__animated animate__fadeIn">
                ...
                <p class="text-center text-gray-600 mb-8">
                    En nuestro complejo deportivo, ofrecemos una experiencia única
                     y accesible para deportistas de todas las edades.
                      Con una amplia variedad de equipos modernos y espacios seguros
                      , garantizamos un ambiente ideal para que los jóvenes
                       y deportistas disfruten al máximo de sus actividades favoritas.
                </p>
